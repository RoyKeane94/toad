...
class MobileGridManager {
    ...
    startTaskEditing(taskElement) {
        ...
        editInput.type = 'text';
        editInput.className = 'w-full px-2 py-1 text-sm border-2 border-dashed border-orange-400 rounded bg-white text-gray-800 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-orange-400';
